  ...
  return (
    <div className="relative w-full overflow-scroll overflow-x-scroll">
      <div className="flex  gap-4 p-2 mt-3 ">
        ...
        <div className="flex-shrink-0 w-40"><img src="https://m.media-amazon.com/images/I/912YrMqFzHL._AC_SY200_.jpg" alt="img 06" className="w-full  cursor-pointer hover:shadow-pink-500 hover:shadow-lg h-[158px]" /><p>img 06</p></div>
